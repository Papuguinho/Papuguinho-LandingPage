        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-16">
          {features.map((feature, index) => {
            ...
            return (
              <Card 
                key={index}
                className="p-6 space-y-4 border-2 hover:border-primary/50 transition-all hover:shadow-lg hover:-translate-y-1"
              >
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 md:p-12 bg-gradient-to-br from-primary/5 to-accent/5 border-2">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-foreground text-center md:text-3xl">
